...
/** 下载页底部说明（略小于正文、略透明，区别于正文） */
export const galleryDownloadInstructionsClass =
  'prose-gallery font-gallery text-[14px] font-normal leading-[1.65] tracking-[0.01em] text-neutral-500/75 antialiased [&_p]:text-[14px] [&_p]:text-neutral-500/80 [&_li]:text-[14px] [&_li]:text-neutral-500/80'
